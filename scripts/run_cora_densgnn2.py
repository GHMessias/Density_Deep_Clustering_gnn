...
def default_config_path() -> Path:
    return PROJECT_ROOT / "configs" / "cora_densgnn2.yaml"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Compatibility wrapper for the YAML-driven Cora + DensGNN2 benchmark.",
    )
    parser.add_argument(
        "--config",
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Override the random seed used by DensGNN2.",
    )
    return parser
