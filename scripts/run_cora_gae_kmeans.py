...
def default_config_path() -> Path:
    return PROJECT_ROOT / "configs" / "cora_gae_kmeans.yaml"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Compatibility wrapper for the YAML-driven Cora + GAE + KMeans benchmark.",
    )
    parser.add_argument(
        "--config",
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Override the random seed used by GAE and KMeans.",
    )
    return parser
